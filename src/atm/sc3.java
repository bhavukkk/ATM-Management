...
public class sc3 extends JFrame implements ActionListener {
    long random;
    ...
    sc3(){
        ...
        JLabel pd = new JLabel("Payment Form");
        pd.setFont(new Font("Raleway",Font.BOLD,20));
        pd.setBounds(350,80,500,100);
        add(pd);

        JLabel name = new JLabel("Payment Name:");
        ...
        JLabel fname = new JLabel("Card Number:");
        ...
        JLabel address = new JLabel("Expiry:");
        ...
        addTextfield.setBounds(350,285,300,30);
        add(addTextfield);

        JLabel city = new JLabel("CVV:");
        city.setFont(new Font("Raleway",Font.BOLD,15));
        city.setBounds(200,300,500,100);
        add(city);

        cityTextfield = new JTextField();
        cityTextfield.setFont(new Font("Raleway",Font.BOLD,12));
        cityTextfield.setBounds(350,335,300,30);
        add(cityTextfield);

        JLabel or = new JLabel("OR");
        or.setFont(new Font("Osward",Font.BOLD,25));
        or.setForeground(Color.BLACK);
        or.setBounds(380,385,200,50);
        add(or);

        JLabel religion = new JLabel("UPI:");
        religion.setFont(new Font("Raleway",Font.BOLD,15));
        religion.setBounds(200,415,500,100);
        add(religion);

        String valreligion[] = {"Paytm","PhonePe","Sikh","Christian","Other"};
        religionbox = new JComboBox<>(valreligion);
        religionbox.setBounds(350,450,300,30);
